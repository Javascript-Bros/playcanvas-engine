Object.assign(
  ...
  (function() {
    ...
    var ElementComponentSystem = function ElementComponentSystem(app) {
      ...
      this._defaultTexture = new pc.Texture(app.graphicsDevice, {
        width: 1,
        height: 1,
    ...
    ElementComponentSystem.prototype = Object.create(
      pc.ComponentSystem.prototype
    );
    ...
    Object.assign(ElementComponentSystem.prototype, {
      initializeComponentData: function(component, data, properties) {
        ...
        var splitHorAnchors =
          Math.abs(component.anchor.x - component.anchor.z) > 0.001;
        var splitVerAnchors =
        ...
        component.batchGroupId =
          data.batchGroupId === undefined || data.batchGroupId === null
            ? -1
            : data.batchGroupId;
        ...
        pc.ComponentSystem.prototype.initializeComponentData.call(
          this,
          component,
          data,
          properties
      ...
      cloneComponent: function(entity, clone) {
        ...
        return this.addComponent(clone, {
          ...
          alignment:
            (source.alignment && source.alignment.clone()) || source.alignment,
          ...
          mask: source.mask,
          outlineColor:
            (source.outlineColor && source.outlineColor.clone()) ||
            source.outlineColor,
          outlineThickness: source.outlineThickness,
          shadowColor:
            (source.shadowColor && source.shadowColor.clone()) ||
            source.shadowColor,
          shadowOffset:
            (source.shadowOffset && source.shadowOffset.clone()) ||
            source.shadowOffset
        });
      },
        ...
        if (screenSpace) {
          if (msdf) {
            if (!this.defaultScreenSpaceTextMaterial) {
              ...
              this.defaultScreenSpaceTextMaterial.name =
              ...
              this.defaultScreenSpaceTextMaterial.blendType =
          ...
          if (!this.defaultScreenSpaceBitmapTextMaterial) {
            ...
            this.defaultScreenSpaceBitmapTextMaterial.name =
              "defaultScreenSpaceBitmapTextMaterial";
            this.defaultScreenSpaceBitmapTextMaterial.emissive.set(
              0.5,
              0.5,
              0.5
            ); // set to non-(1,1,1) so that tint is actually applied
            ...
            this.defaultScreenSpaceBitmapTextMaterial.blendType =
              pc.BLEND_PREMULTIPLIED;
      ...
      getImageElementMaterial: function(
        screenSpace,
        mask,
        nineSliced,
        nineSliceTiled
          ...
          if (mask) {
            ...
            if (nineSliced) {
              if (!this.defaultImage9SlicedMaterial) {
                ...
                this.defaultImage9SlicedMaterial.nineSlicedMode =
                  pc.SPRITE_RENDERMODE_SLICED;
              ...
              if (!this.defaultImage9TiledMaterial) {
                ...
                this.defaultImage9TiledMaterial.nineSlicedMode =
                  pc.SPRITE_RENDERMODE_TILED;
