  ...
  (function() {
    ...
    Object.assign(ElementComponent.prototype, {
      ...
      _setPosition: (function() {
        ...
        return function(x, y, z) {
          ...
          if (!this._dirtyLocal) this._dirtify(true);
        };
      })(),
            ...
            if (screen) {
              ...
              if (parent && parent.element && parent !== screen) {
                matA.setTRS(
                  ...
                  parent.getLocalScale()
                );
                parentWorldTransform.mul2(
                  parent.element._parentWorldTransform,
                  matA
                );
              }
              ...
              pivotOffset.set(
                ...
                element._absBottom +
                  element._pivot.y * element.calculatedHeight,
                0
              );
      ...
      _dirtifyMask: function() {
        ...
        while (current) {
          ...
          if ((next === null || next.screen) && current.element) {
            ...
            // #ifdef DEBUG
            if (_debugLogging)
              console.log("set prerender root to: " + current.name);
            // #endif
          }
      ...
      onLayersChanged: function(oldComp, newComp) {
        this.addModelToLayers(
          this._image ? this._image._model : this._text._model
        );
    ...
    Object.defineProperty(ElementComponent.prototype, "drawOrder", {
      ...
      set: function(value) {
        ...
        if (value > 0xffffff) {
          // #ifdef DEBUG
          console.warn(
            "Element.drawOrder larger than max size of: " + 0xffffff
          );
          // #endif
          value = 0xffffff;
        }
    ...
    Object.defineProperty(ElementComponent.prototype, "anchor", {
      ...
      set: function(value) {
        ...
        if (!this.entity._dirtyLocal) this.entity._dirtify(true);
