  ...
  (function() {
    ...
    Object.assign(TextElement.prototype, {
      ...
      _updateText: function(text) {
        ...
        for (i = 0; i < textLength; i++) {
          ...
          if (!charactersPerTexture[map]) charactersPerTexture[map] = 0;
        ...
        for (i = 0, len = this._meshInfo.length; i < len; i++) {
          ...
          if (meshInfo.count !== l) {
            ...
            var mesh = pc.createMesh(
              this._system.app.graphicsDevice,
              meshInfo.positions,
              {
                uvs: meshInfo.uvs,
            ...
            this._shadowOffsetUniform[1] =
              this._shadowOffsetScale * this._shadowOffset.y;
      ...
      _updateMaterial: function(screenSpace) {
        ...
        if (this._model) {
          for (
            var i = 0, len = this._model.meshInstances.length;
            i < len;
            i++
          ) {
            var mi = this._model.meshInstances[i];
      ...
      _updateMeshes: function(symbols) {
        ...
        var splitHorizontalAnchors =
          Math.abs(this._element.anchor.x - this._element.anchor.z) >= 0.0001;
        ...
        for (i = 0; i < l; i++) {
          ...
          if (
            candidateLineWidth >= maxLineWidth &&
            numCharsThisLine > 0 &&
            !isWhitespace
          ) {
            ...
            if (numWordsThisLine === 0) {
              ...
              if (this._meshInfo.length <= 1) {
                ...
                for (var j = wordStartIndex; j < i; j++) {
                  ...
                  var backMeshInfo = this._meshInfo[
                    (backCharData && backCharData.map) || 0
                  ];
        ...
        for (i = 0; i < this._meshInfo.length; i++) {
            ...
            var hoffset =
              ...
              ha *
                (this._element.calculatedWidth -
                  this._lineWidths[parseInt(line, 10)]);
            var voffset =
          ...
          var it = new pc.VertexIterator(
            this._meshInfo[i].meshInstance.mesh.vertexBuffer
          );
          for (var v = 0; v < numVertices; v++) {
            ...
            it.element[pc.SEMANTIC_TEXCOORD0].set(
          ...
          this._meshInfo[i].meshInstance.mesh.aabb.compute(
            this._meshInfo[i].positions
          );
    ...
    Object.defineProperty(TextElement.prototype, "autoHeight", {
      ...
      set: function(value) {
        ...
        if (
          value &&
          Math.abs(this._element.anchor.y - this._element.anchor.w) < 0.0001
        ) {
    ...
    Object.defineProperty(TextElement.prototype, "outlineColor", {
      ...
      set: function(value) {
        ...
        if (this._outlineColor === value) {
          console.warn(
            "Setting element.outlineColor to itself will have no effect"
          );
        }
        // #endif
    ...
    Object.defineProperty(TextElement.prototype, "shadowColor", {
      ...
      set: function(value) {
        ...
        if (this._shadowColor === value) {
          console.warn(
            "Setting element.shadowColor to itself will have no effect"
          );
        }
        // #endif
